...
void zmalloc_page_is_underutilized(void* ptr, float ratio, void* stats_ptr, int collect_stats) {
  mi_page_usage_stats_t* p = stats_ptr;
  *p = mi_heap_page_is_underutilized(zmalloc_heap, ptr, ratio, collect_stats);
}
