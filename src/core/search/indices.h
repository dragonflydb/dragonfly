...
struct TagIndex : public BaseStringIndex<SortedVector<DocId>> {
  ...
  DefragmentResult Defragment(size_t quota_usec, PageUsage* page_usage) override;
...
template <typename Container, typename ItFunc> struct DefragmentMap {
  ...
  DefragmentResult Defragment(size_t quota_usec, PageUsage* page_usage, std::string* key) {
