...
#define SIMSIMD_TARGET_SVE_BF16 1
#define SIMSIMD_TARGET_SVE_F16 1
#define SIMSIMD_TARGET_SVE2 1

/*
#define USEARCH_CAN_COMPILE_FP16 1
#define USEARCH_CAN_COMPILE_BFLOAT16 1
#define USEARCH_CAN_COMPILE_BF16 1
#define USEARCH_CAN_COMPILE_FLOAT16 1
*/
