...
using DirectFtVectorPtr = const char*;
...
struct DocumentAccessor {
  ...
  using DirectVectorPtr = search::DirectFtVectorPtr;
  ...
  /* Returns nullopt if the specified field is not a vector or it's different dimension */
