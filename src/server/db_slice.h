...
class DbSlice {
 ...
 public:
  ...
  // Drops pending shard-local async deletions without freeing the queued objects.
  static void ShutdownThreadLocal();

  // Marks db_arr_'s DbTables arena-destruct before the shard's mi_heap_destroy() runs.
