...
#elif ABSL_HAVE_ADDRESS_SANITIZER
// Increase stack size for ASAN builds to match production (kFiberStackBase * 2).
constexpr size_t kFiberDefaultStackSize = 112_KB - 16;
#else
