...
TEST_F(ClusterTieredTest, SetCmdAccounting) {
  ...
  // Prevent the deliberately misordered decrement from tripping the debug underflow assertion.
  // This lets the regression observe the incorrect final accounting instead.
  PadSlot(kTag, 512);
