...
void Metrics::Print(uint64_t uptime, const CommandRegistry* registry, DflyCmd* dfly_cmd,
  ...
  AppendMetricWithoutLabels("shared_buf_overflow_copies_total", "Shared V2 overflow copies",
                            ...
                            &resp->body());
  AppendMetricWithoutLabels(
      "shared_buf_borrow_callback_usec_total", "Shared V2 callback borrow duration",
      conn_stats.shared_buf_borrow_usec_callback, MetricType::COUNTER, &resp->body());
  AppendMetricWithoutLabels("shared_buf_borrow_fiber_usec_total", "Shared V2 fiber borrow duration",
                            conn_stats.shared_buf_borrow_usec_fiber, MetricType::COUNTER,
                            &resp->body());
