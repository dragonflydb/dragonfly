...
template <typename T, std::size_t Extent> struct IsSpan<Span<T, Extent>> : std::true_type {};
...
template <typename T, std::size_t Extent> class Span {
 ...
 public:
  ...
  template <
      typename C,
      std::enable_if_t<
          !IsSpan<C>::value && std::is_pointer_v<decltype(std::declval<C&>().data())> &&
              std::is_convertible_v<
                  std::remove_pointer_t<decltype(std::declval<C&>().data())> (*)[], T (*)[]> &&
...
class Error {
  struct deleter {
    void operator()(wasmtime_error_t* p) const {
      wasmtime_error_delete(p);
    }
  };
...
class Config {
  ...
  struct deleter {
    void operator()(wasm_config_t* p) const {
      wasm_config_delete(p);
    }
  };
...
class Engine {
  ...
  struct deleter {
    void operator()(wasm_engine_t* p) const {
      wasm_engine_delete(p);
    }
  };
...
class ValType {
  ...
  struct deleter {
    void operator()(wasm_valtype_t* p) const {
      wasm_valtype_delete(p);
    }
  };
...
class MemoryType {
 ...
 public:
  ...
  class Ref {
   ...
   public:
    ...
    uint64_t min() const {
      return wasmtime_memorytype_minimum(ptr);
    }
    ...
    bool is_64() const {
      return wasmtime_memorytype_is64(ptr);
    }
  };
 ...
 public:
  ...
  /// size.
  explicit MemoryType(uint32_t min) : MemoryType(wasmtime_memorytype_new(min, false, 0, false)) {
  }
  /// Creates a new 32-bit wasm memory type with the specified minimum number of
...
class TableType {
  ...
  struct deleter {
    void operator()(wasm_tabletype_t* p) const {
      wasm_tabletype_delete(p);
    }
  };
 ...
 public:
  ...
  class Ref {
   ...
   public:
    ...
    uint32_t min() const {
      return wasm_tabletype_limits(ptr)->min;
    }
    ...
    ValType::Ref element() const {
      return wasm_tabletype_element(ptr);
    }
  };
...
class GlobalType {
  ...
  struct deleter {
    void operator()(wasm_globaltype_t* p) const {
      wasm_globaltype_delete(p);
    }
  };
  ...
  class Ref {
   ...
   public:
    ...
    ValType::Ref content() const {
      return wasm_globaltype_content(ptr);
    }
  };
 ...
 public:
  ...
  GlobalType(ValType ty, bool mut)
      : GlobalType(wasm_globaltype_new(ty.ptr.release(),
...
class FuncType {
  ...
  struct deleter {
    void operator()(wasm_functype_t* p) const {
  ...
  class Ref {
   ...
   public:
    ...
    ValType::ListRef params() const {
      return wasm_functype_params(ptr);
    }
 ...
 public:
  ...
  /// Creates a new function type from the given list of parameters and results.
  template <typename P, typename R> static FuncType from_iters(P params, R results) {
...
class ImportType {
 public:
  ...
  class Ref {
    ...
    const wasm_externtype_t* raw_type() {
...
class FrameRef {
 ...
 public:
  ...
  uint32_t func_index() const {
    return wasm_frame_func_index(frame);
  }
  ...
  size_t func_offset() const {
    return wasm_frame_func_offset(frame);
  }
  ...
  size_t module_offset() const {
    return wasm_frame_module_offset(frame);
  }
...
class Trap {
  ...
  struct deleter {
    void operator()(wasm_trap_t* p) const {
      wasm_trap_delete(p);
    }
  };
...
class Module {
  ...
  struct deleter {
    void operator()(wasmtime_module_t* p) const {
      wasmtime_module_delete(p);
    }
  };
...
class WasiConfig {
  ...
  struct deleter {
    void operator()(wasi_config_t* p) const {
      wasi_config_delete(p);
    }
  };
 ...
 public:
  ...
  void inherit_env() {
    wasi_config_inherit_env(ptr.get());
  }
  ...
  /// process.
  void inherit_stdin() {
    return wasi_config_inherit_stdin(ptr.get());
  }
  ...
  /// process.
  void inherit_stdout() {
    return wasi_config_inherit_stdout(ptr.get());
  }
  ...
  /// process.
  void inherit_stderr() {
    return wasi_config_inherit_stderr(ptr.get());
  }

  /// Opens `path` to be opened as `guest_path` in the WASI pseudo-filesystem.
  [[nodiscard]] bool preopen_dir(const std::string& path, const std::string& guest_path) {
...
class Store {
  struct deleter {
    void operator()(wasmtime_store_t* p) const {
      wasmtime_store_delete(p);
    }
  };
 ...
 public:
  ...
  /// limits to the store.
  void limiter(int64_t memory_size, int64_t table_elements, int64_t instances, int64_t tables,
               int64_t memories) {
...
struct V128 {
  ...
  V128() : v128{} {
    memset(&v128[0], 0, sizeof(wasmtime_v128));
  }
...
template <typename R, typename... A> struct WasmHostFunc<R (*)(A...)> {
  ...
  static std::optional<Trap> invoke(F& f, Caller cx, wasmtime_val_raw_t* raw) {
    ...
    return std::apply(
        [&](const auto&... val) { return WasmHostRet<R>::invoke(f, cx, raw, val...); }, params);
  }
};
...
struct WasmHostFunc<R (*)(Caller, A...)> : public WasmHostFunc<R (*)(A...)> {
  ...
  static std::optional<Trap> invoke(F& f, Caller cx, wasmtime_val_raw_t* raw) {
    ...
    return std::apply(
        [&](const auto&... val) { return WasmHostRet<R>::invoke(f, cx, raw, cx, val...); }, params);
  }
};
...
class Func {
  ...
  template <typename F>
  static wasm_trap_t* raw_callback(void* env, wasmtime_caller_t* caller, const wasmtime_val_t* args,
  ...
  template <typename F>
  static wasm_trap_t* raw_callback_unchecked(void* env, wasmtime_caller_t* caller,
 ...
 public:
   ...
   */
  template <typename F, std::enable_if_t<std::is_invocable_r_v<Result<std::monostate, Trap>, F,
                                                               Caller, Span<const Val>, Span<Val>>,
                                         bool> = true>
  Func(Store::Context cx, const FuncType& ty, F f) : func({}) {
    wasmtime_func_new(cx.ptr, ty.ptr.get(), raw_callback<F>, std::make_unique<F>(f).release(),
                      raw_finalize<F>, &func);
  }
   ...
   */
  template <typename F, std::enable_if_t<WasmHostFunc<F>::Params::valid, bool> = true,
  ...
  TrapResult<std::vector<Val>> call(Store::Context cx, const I& begin, const I& end) const {
    ...
    auto* error = wasmtime_func_call(cx.ptr, &func, raw_params.data(), raw_params.size(),
...
template <typename Params, typename Results> class TypedFunc {
 ...
 public:
  ...
  TrapResult<Results> call(Store::Context cx, Params params) const {
    std::array<wasmtime_val_raw_t,
               std::max(WasmTypeList<Params>::size, WasmTypeList<Results>::size)>
        storage;
    ...
    wasm_trap_t* trap = nullptr;
    auto* error =
        wasmtime_func_call_unchecked(cx.raw_context(), &f.func, ptr, storage.size(), &trap);
    if (error != nullptr) {
      return TrapError(Error(error));
    }
    if (trap != nullptr) {
...
class Instance {
 ...
 public:
  ...
  static TrapResult<Instance> create(Store::Context cx, const Module& m,
    ...
    wasmtime_instance_t instance;
    wasm_trap_t* trap = nullptr;
    auto* error = wasmtime_instance_new(cx.ptr, m.ptr.get(), raw_imports.data(), raw_imports.size(),
                                        &instance, &trap);
    if (error != nullptr) {
      return TrapError(Error(error));
    }
...
class Linker {
  struct deleter {
    void operator()(wasmtime_linker_t* p) const {
      wasmtime_linker_delete(p);
    }
  };
 ...
 public:
  ...
  Result<std::monostate> define(Store::Context cx, std::string_view module, std::string_view name,
                                const Extern& item) {
    wasmtime_extern_t raw;
    Instance::cvt(item, raw);
    auto* error = wasmtime_linker_define(ptr.get(), cx.ptr, module.data(), module.size(),
  ...
  Result<std::monostate> define_instance(Store::Context cx, std::string_view name,
                                         Instance instance) {
    auto* error = wasmtime_linker_define_instance(ptr.get(), cx.ptr, name.data(), name.size(),
                                                  &instance.instance);
    if (error != nullptr) {
      return Error(error);
    }
  ...
  [[nodiscard]] std::optional<Extern> get(Store::Context cx, std::string_view module,
                                          std::string_view name) {
    wasmtime_extern_t item;
    if (wasmtime_linker_get(ptr.get(), cx.ptr, module.data(), module.size(), name.data(),
                            name.size(), &item)) {
      return Instance::cvt(item);
    }
    return std::nullopt;
  ...
  template <typename F, std::enable_if_t<std::is_invocable_r_v<Result<std::monostate, Trap>, F,
                                                               Caller, Span<const Val>, Span<Val>>,
                                         bool> = true>
  Result<std::monostate> func_new(std::string_view module, std::string_view name,
                                  const FuncType& ty, F f) {
    auto* error = wasmtime_linker_define_func(
        ptr.get(), module.data(), module.length(), name.data(), name.length(), ty.ptr.get(),
        Func::raw_callback<F>, std::make_unique<F>(f).release(), Func::raw_finalize<F>);
  ...
  Result<std::monostate> func_wrap(std::string_view module, std::string_view name, F f) {
    ...
    auto* error = wasmtime_linker_define_func_unchecked(
        ptr.get(), module.data(), module.length(), name.data(), name.length(), ty.ptr.get(),
        Func::raw_callback_unchecked<F>, std::make_unique<F>(f).release(), Func::raw_finalize<F>);
