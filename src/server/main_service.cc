...
void UpdateFromFlagsOnThread() {
  MultiCommandSquasher::SetMaxBusySquashUsec(GetFlag(FLAGS_max_busy_squash_usec));
...
std::vector<std::string> GetMutableFlagNames() {
  return facade::GetFlagNames(FLAGS_max_busy_squash_usec, FLAGS_shard_thread_busy_polling_usec,
