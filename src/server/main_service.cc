...
void Service::ConfigureHttpHandlers(util::HttpListenerBase* base, bool is_privileged) {
  ...
  const char kRootResp[] = R"(
    <!DOCTYPE html><html lang='en'><head><meta charset='UTF-8'><meta name='viewport' content='width=device-width,initial-scale=1'><title>DragonflyDB</title><style>.terminal{width:100%;height:600px;border-radius:10px;background-color:#212020;color:#fff;font-family:'Courier New',Courier,monospace;padding:20px;overflow:auto;display:flex;flex-direction:column;box-shadow:0 4px 8px rgba(0,0,0,.1);margin-top:20px}.terminal pre{margin:0;margin-bottom:10px;line-height:1.3em;white-space:pre-line}.prompt{display:flex;position:relative}.prompt span{color:#c53ee0;font-family:'Courier New',Courier,monospace;font-size:15px}.prompt input{background-color:#212020;border:none;color:#fff;font-family:'Courier New',Courier,monospace;outline:0;flex-grow:1;margin-left:5px}.prompt input::placeholder{color:#555}.prompt input:focus{border:none;outline:0}.autocomplete{visibility:hidden;min-width:200px;background-color:#383838;color:#fff;padding:5px 0;border-radius:6px;position:fixed;z-index:1000;width:120px;padding:10px 0}.ac-prompt{font-size:14px;padding:5px 15px}div.autocomplete>.ac-prompt:first-child{background:#2c2c2c}:root{--df-color:#5A3EE0}body,http{color:#fff;padding:0;margin:0;background-color:#2c2c2c;top:0;left:0;right:0;bottom:0;position:absolute;font-family:Sans-Serif}header{height:100px;display:flex;justify-content:space-between;align-items:center;background-color:#212020;flex:0 1 auto}.empty-space,.logo{flex:1;display:flex;justify-content:flex-start}.logo img{margin-left:50px}.nav-links{height:100%;font-size:15px;flex:0 1 auto;display:flex;justify-content:center;gap:20px}.tablink{display:flex;align-items:center;padding:20px;cursor:pointer;gap:10px;filter:grayscale(1)}.tablink.active{border-image:linear-gradient(#5A3EE0,#C53EE0) 30;border-bottom:solid 5px;font-weight:900;filter:grayscale(0)}.tab-container{display:flex;flex-direction:column;max-width:1206px;margin:auto;padding-top:50px}.row{display:flex;width:100%}.w-container{flex-grow:1;padding:20px}.w-title{margin-bottom:10px;font-size:20px;font-weight:700}.w-header{font-size:40px;text-align:center;height:45px}.shards-container .w-header{margin-top:10px;font-size:20px}.w-graph{margin-top:10px;height:104px}.graph-container{background-color:#383838;box-shadow:0 4px 8px rgba(0,0,0,.1);padding:10px;border-radius:10px;width:563px}.placeholder{background-color:#333;width:100%;height:200px;border-radius:10px;padding-top:200px;color:#838383;text-align:center;margin-top:20px}#svg-tooltip{position:absolute;padding:10px;background-color:#000;color:#fff;text-align:center;border-radius:10px;pointer-events:none;font-size:13px}#svg-tooltip::after{content:" ";position:absolute;top:100%;left:50%;margin-left:-5px;border-width:5px;border-style:solid;border-color:#000 transparent transparent transparent}table,td,tr{border:none;font-size:15px}table{padding:20px;background-color:#333;border-radius:10px;margin-bottom:50px}td,th{padding:10px}th{border-bottom:2px solid #2c2c2c;padding-bottom:25px;font-size:14px}tr:nth-child(2n){background-color:#383838}</style></head><body><header><div class='logo'><img src='data:image/png;base64,'></div><div class='nav-links'><div id='dashboard-link' class='tablink' onclick='openTab(&#39;dashboard&#39;)'><img src='data:image/png;base64,'><div>Dashboard</div></div><div id='cli-link' class='tablink' onclick='openTab(&#39;cli&#39;)'><img src='data:image/png;base64,'><div>CLI</div></div><div id='performance-link' class='tablink' onclick='openTab(&#39;performance&#39;)'><img src='data:image/png;base64,'><div>Slow Log</div></div><div id='achievements-link' class='tablink' onclick='openTab(&#39;achievements&#39;)'><img src='data:image/png;base64,'><div>Achievements</div></div></div><div class='empty-space'></div></header><main><section id='dashboard' class='tab-container'><div class='row'><div id='uptime' class='w-container'></div><div id='total_commands_num' class='w-container'></div></div><div class='row'><div id='used_memory_bytes' class='w-container'></div><div id='num_connected_clients' class='w-container'></div></div><div class='row'><div id='qps' class='w-container'></div><div id='hit_rate' class='w-container'></div></div><div class='w-title' style='padding-left:20px;margin-bottom:-10px'>Shard Stats</div><div class='row shards-container'><div id='used_memory' class='w-container'></div><div id='key_count' class='w-container'></div></div><div class='row shards-container'><div id='expire_count' class='w-container'></div><div id='key_reads' class='w-container'></div></div><div id='svg-tooltip' style='display:none'></div></section><section id='cli' class='tab-container'><div class='terminal' id='terminal'></div></section><section id='performance' class='tab-container'><div id='slow-log-placeholder' class='placeholder'>Loading...</div><table id='slow-log-table' style='display:none'><thead><tr style='text-align:left'><th>Timestamp</th><th>Duration</th><th>Command</th></tr></thead><tbody></tbody></table></section><section id='achievements' class='tab-container'><div class='placeholder'>This tab is available only online. Please check your internet connection and try again.</div></section></main><script>const PROMPT_PREFIX='dragonfly>',API_URL='/api',UPDATE_INTERVAL=1e3,HISTORY_WINDOW=60,ACHIEVEMENTS_URL='http://static.dragonflydb.io/data-plane/achievements.html';; function formatCommands(e){return(e[0]||'').trim().split(' ')}async function executeCommands(e,t,n,a,o){try{var i,l,r=await execute(a,e);for([i,l]of a.entries())await writeLines(t,n,l,formatReply(r),o,!1)}catch(e){for(const c of a)await writeLines(t,n,c,e.message,o)}}function formatReply(e,t=0){if(null===e)return'(nil)';try{var n=e;return n.error?n.error:n.result||JSON.stringify(n)}catch(e){return e.message}}const autocomplete={};function initAutocomplete(e){autocomplete.element=e}function positionAutocomplete(){var e=autocomplete.element.parentElement.getBoundingClientRect();autocomplete.element.style.left=e.left+100+'px',autocomplete.element.style.top=e.top+20+'px'}async function updateAutoComplete(t){if(t&&t.length){var e=(await fetchCommands()).filter(e=>e.startsWith(t.toUpperCase())).filter((e,t,n)=>n.indexOf(e)===t).sort((e,t)=>e.localeCompare(t));if(1==e.length&&e[0]==t)return void(autocomplete.element.style.visibility='hidden');if(e.length)return autocomplete.matches=e,autocomplete.element.style.visibility='visible',autocomplete.element.textContent='',e.forEach(e=>{var t=document.createElement('div');t.className='ac-prompt',t.textContent=e,autocomplete.element.appendChild(t)}),void positionAutocomplete()}autocomplete.element.style.visibility='hidden'}function applyAutocomplete(e){autocomplete.matches&&autocomplete.matches.length&&(setInputValue(e,autocomplete.matches[0]),updateAutoComplete(autocomplete.matches[0]))}async function createCli(n){const e=getCommandsToExecute(n),a=(n.replaceChildren(),createPre(n)),[o,i]=createPrompt(n),l=n.getAttribute('dbid');drawTerminal(n),handleHistory(a,o),o.addEventListener('keydown',e=>{if('Enter'===e.key){e.preventDefault();const t=o.value;if(updateAutoComplete(o.value=''),!t.trim())return;disablePrompt(n,o,i,()=>executeInputCommand(l,a,o,t))}'Tab'===e.key&&(e.preventDefault(),applyAutocomplete(o))}),o.addEventListener('input',e=>{updateAutoComplete(e.target.value)}),e&&disablePrompt(n,o,i,()=>executeCommands(l,a,o,e))}function drawTerminal(e){if(isTerminal(e)){const n=document.createElement('div');n.classList.add('bar');['#d00','#0d0','#00d'].forEach(e=>{var t=document.createElement('span');t.classList.add('button'),n.appendChild(t)}),e.classList.add('terminal'),e.prepend(n)}}function isTerminal(e){return null!==e.getAttribute('terminal')}function getCommandsToExecute(e){e=e.textContent.trim();if(e)return e.split('\n').map(e=>e.trim())}function createPre(e){var t=document.createElement('pre');return t.setAttribute('tabindex','0'),e.appendChild(t),t}function createPrompt(e){var t=document.createElement('div'),n=(t.classList.add('prompt'),document.createElement('span'));n.appendChild(document.createTextNode(PROMPT_PREFIX)),t.appendChild(n);const a=document.createElement('input');a.setAttribute('name','prompt'),a.setAttribute('type','text'),a.setAttribute('autocomplete','off'),a.setAttribute('spellcheck','false'),t.appendChild(a);n=document.createElement('div');return n.classList.add('autocomplete'),n.setAttribute('id','autocomplete'),t.appendChild(n),initAutocomplete(n),e.appendChild(t),e.addEventListener('click',()=>{'Range'!==document.getSelection().type&&a.focus()}),e.addEventListener('keydown',e=>{e.target===a||e.ctrlKey||e.altKey||e.shiftKey||e.metaKey||(a.focus(),a.scrollIntoView({block:'nearest'}))}),[a,t]}async function disablePrompt(e,t,n,a){e.classList.add('disabled'),t.disabled=!0,n.style.display='none';Promise.all([a()]).then(()=>{n.style.display='',e.classList.remove('disabled'),t.disabled=!1,t.focus({preventScroll:!0})})}function handleHistory(n,a){let o=0,i='';a.addEventListener('keydown',e=>{switch(e.key){case'ArrowUp':if(e.preventDefault(),o===Math.floor(n.childNodes.length/2))return;0===o&&(i=a.value),++o;break;case'ArrowDown':if(e.preventDefault(),0===o)return;if(0==--o)return void setInputValue(a,i);break;default:return}var t=n.childNodes[n.childNodes.length-2*o]['nodeValue'];setInputValue(a,t.substring(PROMPT_PREFIX.length,t.length-1))})}function setInputValue(e,t){e.value=t,e.setSelectionRange(t.length,t.length)}async function writeLines(e,t,n,a,o){await writeLine(e,t,n,o,!0),await writeLine(e,t,a,!1,!1)}async function executeInputCommand(e,t,n,a){'clear'===a.toLowerCase()?t.replaceChildren():executeCommands(e,t,n,[a])}let id;async function execute(e,t=0){e=await(await fetch(API_URL,{method:'POST',mode:'cors',cache:'no-cache',credentials:'same-origin',headers:{'Content-Type':'application/json'},body:JSON.stringify(formatCommands(e))})).json();return id=e.id,e}async function writeLine(e,t,n,a,o){var i=document.createTextNode(''),e=(e.appendChild(i),n+'\n'),l=(o&&(i.nodeValue=PROMPT_PREFIX),i.nodeValue+=e,t.scrollIntoView({block:'nearest'}),document.getElementById('terminal'));setTimeout(()=>l.scrollTop=l.scrollHeight,10)}document.addEventListener('DOMContentLoaded',()=>{createCli(document.getElementById('terminal'))});; async function fetchData(s,a=!0){try{var e=await fetch(API_URL,{method:'POST',mode:'cors',cache:'no-cache',credentials:'same-origin',headers:{'Content-Type':'application/json'},body:JSON.stringify(formatCommands([s]))});let t=null;return t=a?await e.json():await e.text()}catch(t){console.log('cannot fetch data for command ',s,a,t)}return null}function formatTime(t){var s,a,e,o,r,n;return isNaN(t)||t<0?'Invalid input':(s=Math.floor(t/31557600),t%=31557600,a=Math.floor(t/(30.44*24*60*60)),t%=30.44*24*60*60,e=Math.floor(t/86400),t%=86400,o=Math.floor(t/3600),t%=3600,r=Math.floor(t/60),t%=60,n=[],0<s&&n.push(s+' year'+(1<s?'s':'')),0<a&&n.push(a+' month'+(1<a?'s':'')),0<e&&n.push(e+' day'+(1<e?'s':'')),0<o&&n.push(o+' hour'+(1<o?'s':'')),0<r&&n.push(r+' minute'+(1<r?'s':'')),0<t&&n.push(t+' second'+(1<t?'s':'')),n.join(', '))}function parseCommands(t){return t.match(/([A-Z]+)/g)||[]}async function fetchCommands(){return parseCommands(await fetchData('command',!1))}function parseRedisInfo(t){var s,a,e={};let o=null;for(const r of t.split('\r\n'))r.startsWith('#')?e[o=r.substring(2).trim()]={}:r.trim()&&([s,a]=r.split(':'),e[o][s]=a);return e}async function updateStats(){var t,s,a,e=parseRedisInfo((await fetchData('info all')).result);globalStats.qps.push(e.Stats.instantaneous_ops_per_sec),globalStats.num_connected_clients.push(e.Clients.connected_clients),globalStats.used_memory_bytes.push(e.Memory.used_memory),globalStats.max_memory_bytes.push(e.Memory.maxmemory),globalStats.uptime.push(formatTime(e.Server.uptime_in_seconds)),globalStats.cpu.push(e.Cpu.used_cpu_sys),globalStats.total_commands_num.push(e.Stats.total_commands_processed),0<e.Stats.keyspace_hits?(t=(t=parseInt(e.Stats.keyspace_hits,10))/(t+parseInt(e.Stats.keyspace_misses,10))*100,t=Math.round(100*t)/100,globalStats.hit_rate.push(t)):globalStats.hit_rate.push(0);for([s,a]of Object.entries(globalStats))'shards_stats'!=s&&globalStats[s].length>HISTORY_WINDOW&&globalStats[s].shift()}function parseShardInfo(t){var s={},a=/^shard(\d+)_(\w+): (\d+)$/;for(const n of t.split('\n')){var e,o,r=n.match(a);r?(e=r[1],o=r[2],r=parseInt(r[3],10),s[e]||(s[e]={}),s[e][o]=r):([e,o]=n.split(': '),s[e]=parseInt(o,10)||o)}return s}async function updateShardStats(){var t=await fetchData('debug shards');for(shards=parseShardInfo(t.result),globalStats.shards_stats.used_memory=[],globalStats.shards_stats.key_count=[],globalStats.shards_stats.expire_count=[],globalStats.shards_stats.key_reads=[],i=0;i<shards.num_shards;i++)globalStats.shards_stats.used_memory.push(shards[i].used_memory),globalStats.shards_stats.key_count.push(shards[i].key_count),globalStats.shards_stats.expire_count.push(shards[i].expire_count),globalStats.shards_stats.key_reads.push(shards[i].key_reads)}function extractTimeAndDuration(t){var s=t.indexOf('17');return[t.slice(s,s+10),t.slice(s+10)]}function parseSlowLog(t){t=t.slice(11,-4).replaceAll('[','').split('"""');const a=[];return t.forEach(t=>{var t=t.replaceAll('""','"').split('"'),s=extractTimeAndDuration(t[0]);a.push({time:s[0],duration:s[1],command:t[1],key:t[2]})}),a}async function fetchSlowLog(){return parseSlowLog(await fetchData('slowlog get 50',!1))}globalStats={cpu:[],qps:[],used_memory_bytes:[],max_memory_bytes:[],num_connected_clients:[],uptime:[],total_commands_num:[],hit_rate:[],shards_stats:{used_memory:[],key_count:[],expire_count:[],key_reads:[]}};; function getSVG(t,a){var{bars:e,suffix:n}=a;const s='http://www.w3.org/2000/svg',l=document.createElementNS(s,'svg'),r=document.getElementById('svg-tooltip');if(t&&t.length){const v=17+4*Math.max(...t.map(t=>E(t).length)),w=550,C=100,x=10;if(l.setAttribute('width',w),l.setAttribute('height',C),t&&!(t.length<2)){{var i=l;var o='df-gradient';var d=[{offset:'0%',color:'#5A3EE0'},{offset:'100%',color:'#C53EE0'}];const S=i.querySelector('defs')||i.appendChild(document.createElementNS(s,'defs')),N=document.createElementNS(s,'linearGradient');N.setAttribute('id',o),N.setAttribute('x1','0%'),N.setAttribute('y1','0%'),N.setAttribute('x2','0%'),N.setAttribute('y2','100%'),d.forEach(t=>{var e=document.createElementNS(s,'stop');e.setAttribute('offset',t.offset),e.setAttribute('stop-color',t.color),N.appendChild(e)}),S.appendChild(N)}let r=Math.max(...t);r='%'==n&&r<=100?100:0===r||1<=r&&r<=10?10:1===[...new Set(t)].length?2*r:r,r=(i=r)%(o=4)==0?i:i+(o-i%o);let a;a=t.map(t=>90-t/r*80);for(let t=0;t<=4;t++){var u=Math.round(x+20*t),c=r*(1-t/4),h=document.createElementNS(s,'line'),h=(h.setAttribute('x1',v),h.setAttribute('y1',u),h.setAttribute('x2',w),h.setAttribute('y2',u),h.setAttribute('stroke','#525259'),h.setAttribute('stroke-width','1'),h.setAttribute('shape-rendering','crispEdges'),l.appendChild(h),document.createElementNS(s,'text'));h.setAttribute('x',v-5),h.setAttribute('y',u+4),h.setAttribute('font-size','10px'),h.setAttribute('fill','#525259'),h.setAttribute('text-anchor','end'),h.textContent=E(c),l.appendChild(h)}if(e){const B=w/t.length*.3,M=(w-v-B*(t.length+1))/t.length;t.forEach((t,e)=>{let n=t/r*80;0==n&&(n=1);var e=v+B+(M+B)*e,i=C-n-x,a=document.createElementNS(s,'rect');a.setAttribute('x',e),a.setAttribute('width',M),a.setAttribute('y',i),a.setAttribute('height',n),a.setAttribute('fill','url(#df-gradient)'),a.setAttribute('style','cursor: pointer;'),l.appendChild(a),A(a,t),l.appendChild(a)})}else{const T=(w-v-20)/HISTORY_WINDOW,L=10+v+(HISTORY_WINDOW-t.length)*T;let e=`M ${L} `+a[0];d=a.every(t=>t===a[0]),n=document.createElementNS(s,'path');if(d){d=Math.round(540);e+=` L ${d} `+a[0],n.setAttribute('stroke','#C53EE0')}else{for(let t=1;t<a.length;t++){var m=L+T*(t-1),p=a[t-1],g=L+T*t,b=a[t],f=T/2,m=m+f,f=g-f,y=b;e+=` C ${m},${p} ${f},${y} ${g},`+b}n.setAttribute('stroke','url(#df-gradient)')}n.setAttribute('d',e),n.setAttribute('stroke-width','2'),n.setAttribute('fill','none'),l.appendChild(n),t.forEach((t,e)=>{var n=L+T*e,e=a[e],i=document.createElementNS(s,'circle');i.setAttribute('cx',n),i.setAttribute('cy',e),i.setAttribute('r',5),i.setAttribute('fill','#C53EE0'),i.setAttribute('opacity',0),i.setAttribute('style','cursor: pointer;'),A(i,t,!0),l.appendChild(i)})}}}return l;function E(t){if(0===(t=Number(t)))return'0';var e=t<0,n=(t=Math.abs(t),Math.floor(Math.log10(t)/3));let i=t/Math.pow(1e3,n);return(e?'-':'')+(i=i.toFixed(1)).replace(/\.0$/,'')+['','K','M','B'][n]}function A(e,n,i){e.addEventListener('mouseover',t=>{i&&e.setAttribute('opacity',1),r.style.display='block',r.textContent=formatValue(n,a);t=t.target.getBoundingClientRect();r.style.left=t.x+window.scrollX+t.width/2-r.clientWidth/2+'px',r.style.top=t.y+window.scrollY-r.clientHeight-10+'px'}),e.addEventListener('mousemove',t=>{t=t.target.getBoundingClientRect();r.style.left=t.x+window.scrollX+t.width/2-r.clientWidth/2+'px',r.style.top=t.y+window.scrollY-r.clientHeight-10+'px'}),e.addEventListener('mouseout',()=>{i&&e.setAttribute('opacity',0),r.style.display='none'})}}function formatValue(e,t){if(!e&&0!=e)return'';if('uptime'==t.id)return 2<(a=e.split(',')).length&&a.pop(),a.join(',');if(e=Number(e),t.id.startsWith('used_memory')){var n=e;if(Math.abs(n)<1e3)return n+' B';var i=['kB','MB','GB','TB','PB','EB','ZB','YB'];let t=-1;for(;n/=1e3,++t,1e3<=Math.round(10*Math.abs(n))/10&&t<i.length-1;);var a=n.toFixed(1),r=a.split('.')[1],r=r&&0!==parseInt(r);return(r?a:Math.round(n))+i[t]}return''+e.toLocaleString('en-US')+(t.suffix||'')}function openTab(t){var e,n,i;for('performance'==t&&fetchSlowLog().then(t=>loadSlowLog(t)),n=document.getElementsByClassName('tab-container'),e=0;e<n.length;e++)n[e].style.display='none';for(i=document.getElementsByClassName('tablink'),e=0;e<i.length;e++)i[e].className=i[e].className.replace(' active','');document.getElementById(t).style.display='flex',document.getElementById(t+'-link').className+=' active';var a=new URLSearchParams(window.location.search);a.set('tab',t),window.history.replaceState({},'',window.location.pathname+'?'+a)}function initGraphs(){[{id:'uptime',title:'Up Time',graph:!1},{id:'total_commands_num',title:'Total Commands',graph:!1},{id:'used_memory_bytes',title:'Memory'},{id:'num_connected_clients',title:'Connected Clients'},{id:'qps',title:'QPS'},{id:'hit_rate',title:'Hit Rate',suffix:'%'},{id:'used_memory',title:'Used Memory',bars:!0},{id:'key_count',title:'Key Count',bars:!0},{id:'expire_count',title:'Expire Count',bars:!0},{id:'key_reads',title:'Key Reads',bars:!0}].forEach(t=>initWidget(t))}function initWidget(t){var e=new Widget(t);document.getElementById(t.id).appendChild(e.html.element)}function Widget(s){this.settings=s,this.html=function({title:t,bars:e}){var n={},i=document.createElement('div');e||((a=document.createElement('div')).textContent=t,a.className='w-title',i.appendChild(a),n.title=a);var a=document.createElement('div'),r=(a.className='graph-container',i.appendChild(a),document.createElement('div'));r.className='w-header',e&&(r.textContent=t);a.appendChild(r),null!=s.graph&&!s.graph||((e=document.createElement('div')).className='w-graph',a.appendChild(e),n.graph=e);return{...n,element:i,header:r}}(s);const e=this;setInterval(()=>{s.bars||e.updateHeader(),null!=e.settings.graph&&!e.settings.graph||e.updateGraph()},UPDATE_INTERVAL),this.updateHeader=()=>{var t=this.stats();this.html.header.textContent=formatValue(t[t.length-1],s)},this.updateGraph=()=>{var t=getSVG(this.stats(),this.settings);e.html.graph.textContent='',e.html.graph.appendChild(t)},this.stats=()=>(this.settings.bars?globalStats.shards_stats:globalStats)[this.settings.id]}function loadSlowLog(t){document.getElementById('slow-log-placeholder').style.display='none';var e=document.getElementById('slow-log-table');e.style.display='';const a=e.getElementsByTagName('tbody')[0];function r(t,e){var n=document.createElement('td');n.textContent=e,t.appendChild(n)}a.innerHTML='',t.sort((t,e)=>e.time-t.time).forEach(t=>{var e,n,i=document.createElement('tr');r(i,(e=1e3*Number(t.time),e=new Date(e),n=e.toLocaleDateString('en-US',{day:'2-digit',month:'short',year:'numeric'}),(e=e.toLocaleTimeString('en-US',{hour:'2-digit',minute:'2-digit',second:'2-digit',hour12:!1}))+' '+n)),r(i,t.duration),r(i,t.command+' '+t.key),a.appendChild(i)})}function initTabs(){var t=new URLSearchParams(window.location.search).get('tab');openTab(t||'dashboard')}window.addEventListener('DOMContentLoaded',t=>{initTabs(),initGraphs(),setInterval(updateStats,UPDATE_INTERVAL),setInterval(updateShardStats,UPDATE_INTERVAL),loadAchievementsTab()});; async function loadAchievementsTab(){try{var e,t,c=await fetch(ACHIEVEMENTS_URL);c.ok&&(e=await c.text(),(t=document.getElementById('achievements')).innerHTML=e,t.querySelectorAll('script').forEach(e=>{var t=document.createElement('script');e.src?t.src=e.src:t.textContent=e.textContent,document.body.appendChild(t),document.body.removeChild(t)}))}catch(e){}}</script></body></html>
  )";
