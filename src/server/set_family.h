...
class SetFamily {
 public:
  ...
  static LoadBlobResult LoadIntSetBlob(std::string_view blob, PrimeValue* pv, bool deep);
  static LoadBlobResult LoadLPSetBlob(std::string_view blob, PrimeValue* pv, bool deep);
