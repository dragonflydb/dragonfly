...
class EngineShard {
 public:
  ...
  static void InitThreadLocal(util::ProactorBase* pb, bool update_db_time, uint64_t max_file_size);
...
class EngineShardSet {
 ...
 private:
  void InitThreadLocal(util::ProactorBase* pb, bool update_db_time, uint64 max_file_size);
