...
async def test_pubsub_pipeline_starvation_assertive(df_server: DflyInstance):
    reader, writer = await asyncio.open_connection("127.0.0.1", df_server.port)
    # send subscribe and consume the standarad RESP reply to clean the socket buffer
