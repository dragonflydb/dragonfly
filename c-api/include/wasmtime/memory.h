 ...
 */
WASM_API_EXTERN wasm_memorytype_t* wasmtime_memorytype_new(uint64_t min, bool max_present,
                                                           uint64_t max, bool is_64);
 ...
 */
WASM_API_EXTERN wasm_memorytype_t* wasmtime_memory_type(const wasmtime_context_t* store,
 ...
 */
WASM_API_EXTERN size_t wasmtime_memory_data_size(const wasmtime_context_t* store,
                                                 const wasmtime_memory_t* memory);
