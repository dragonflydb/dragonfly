 ...
 *        disable yielding.
 */
WASM_API_EXTERN wasmtime_error_t* wasmtime_context_fuel_async_yield_interval(
    wasmtime_context_t* context, uint64_t interval);
 ...
 */
typedef void (*wasmtime_func_async_callback_t)(void* env, wasmtime_caller_t* caller,
...
WASM_API_EXTERN wasmtime_call_future_t* wasmtime_func_call_async(
    wasmtime_context_t* context, const wasmtime_func_t* func, const wasmtime_val_t* args,
    size_t nargs, wasmtime_val_t* results, size_t nresults, wasm_trap_t** trap_ret,
...
WASM_API_EXTERN wasmtime_error_t* wasmtime_linker_define_async_func(
    ...
    size_t name_len, const wasm_functype_t* ty, wasmtime_func_async_callback_t cb, void* data,
    void (*finalizer)(void*));
...
WASM_API_EXTERN wasmtime_call_future_t* wasmtime_linker_instantiate_async(
    const wasmtime_linker_t* linker, wasmtime_context_t* store, const wasmtime_module_t* module,
    wasmtime_instance_t* instance, wasm_trap_t** trap_ret, wasmtime_error_t** error_ret);
 ...
 */
typedef uint8_t* (*wasmtime_stack_memory_get_callback_t)(void* env, size_t* out_len);
 ...
 */
WASM_API_EXTERN void wasmtime_config_host_stack_creator_set(wasm_config_t*,
                                                            wasmtime_stack_creator_t*);
