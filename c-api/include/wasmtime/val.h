...
WASM_API_EXTERN void wasmtime_anyref_clone(wasmtime_context_t* context,
                                           const wasmtime_anyref_t* anyref, wasmtime_anyref_t* out);
 ...
 */
WASM_API_EXTERN void wasmtime_anyref_unroot(wasmtime_context_t* context, wasmtime_anyref_t* ref);
 ...
 * `raw`.
 */
WASM_API_EXTERN void wasmtime_anyref_from_raw(wasmtime_context_t* context, uint32_t raw,
 ...
 */
WASM_API_EXTERN void wasmtime_anyref_from_i31(wasmtime_context_t* context, uint32_t i31val,
                                              wasmtime_anyref_t* out);
...
WASM_API_EXTERN bool wasmtime_anyref_i31_get_u(wasmtime_context_t* context,
                                               const wasmtime_anyref_t* anyref, uint32_t* dst);
...
WASM_API_EXTERN bool wasmtime_anyref_i31_get_s(wasmtime_context_t* context,
                                               const wasmtime_anyref_t* anyref, int32_t* dst);
 ...
 */
WASM_API_EXTERN bool wasmtime_externref_new(wasmtime_context_t* context, void* data,
                                            void (*finalizer)(void*), wasmtime_externref_t* out);
 ...
 */
WASM_API_EXTERN void wasmtime_externref_from_raw(wasmtime_context_t* context, uint32_t raw,
                                                 wasmtime_externref_t* out);
 ...
 * passing it to WebAssembly.
 */
WASM_API_EXTERN uint32_t wasmtime_externref_to_raw(wasmtime_context_t* context,
                                                   const wasmtime_externref_t* ref);
 ...
 * funcref values.
 */
WASM_API_EXTERN void wasmtime_val_unroot(wasmtime_context_t* context, wasmtime_val_t* val);
 ...
 */
WASM_API_EXTERN void wasmtime_val_clone(wasmtime_context_t* context, const wasmtime_val_t* src,
                                        wasmtime_val_t* dst);
