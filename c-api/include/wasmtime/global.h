 ...
 * owned by the caller.
 */
WASM_API_EXTERN wasmtime_error_t* wasmtime_global_new(wasmtime_context_t* store,
 ...
 */
WASM_API_EXTERN wasm_globaltype_t* wasmtime_global_type(const wasmtime_context_t* store,
 ...
 */
WASM_API_EXTERN void wasmtime_global_get(wasmtime_context_t* store, const wasmtime_global_t* global,
                                         wasmtime_val_t* out);
 ...
 * error.
 */
WASM_API_EXTERN wasmtime_error_t* wasmtime_global_set(wasmtime_context_t* store,
                                                      const wasmtime_global_t* global,
                                                      const wasmtime_val_t* val);
