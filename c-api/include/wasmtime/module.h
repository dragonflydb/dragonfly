 ...
 */
WASM_API_EXTERN wasmtime_error_t* wasmtime_module_new(wasm_engine_t* engine, const uint8_t* wasm,
                                                      size_t wasm_len, wasmtime_module_t** ret);
 ...
 */
WASM_API_EXTERN wasmtime_error_t* wasmtime_module_validate(wasm_engine_t* engine,
 ...
 */
WASM_API_EXTERN wasmtime_error_t* wasmtime_module_serialize(wasmtime_module_t* module,
                                                            wasm_byte_vec_t* ret);
 ...
 */
WASM_API_EXTERN wasmtime_error_t* wasmtime_module_deserialize(wasm_engine_t* engine,
                                                              const uint8_t* bytes,
                                                              size_t bytes_len,
 ...
 * (e.g. only that of #wasmtime_module_serialize)
 */
WASM_API_EXTERN wasmtime_error_t* wasmtime_module_deserialize_file(wasm_engine_t* engine,
                                                                   const char* path,
                                                                   wasmtime_module_t** ret);
 ...
 */
WASM_API_EXTERN void wasmtime_module_image_range(const wasmtime_module_t* module, void** start,
                                                 void** end);
