 ...
 * is expected to delete the returned linker.
 */
WASM_API_EXTERN wasmtime_linker_t* wasmtime_linker_clone(wasmtime_linker_t* linker);
 ...
 */
WASM_API_EXTERN wasmtime_error_t* wasmtime_linker_define(wasmtime_linker_t* linker,
 ...
 */
WASM_API_EXTERN wasmtime_error_t* wasmtime_linker_define_func(wasmtime_linker_t* linker,
                                                              const char* module, size_t module_len,
                                                              const char* name, size_t name_len,
...
WASM_API_EXTERN wasmtime_error_t* wasmtime_linker_define_func_unchecked(
    wasmtime_linker_t* linker, const char* module, size_t module_len, const char* name,
    size_t name_len, const wasm_functype_t* ty, wasmtime_func_unchecked_callback_t cb, void* data,
    void (*finalizer)(void*));
...
WASM_API_EXTERN wasmtime_error_t* wasmtime_linker_define_instance(
    wasmtime_linker_t* linker, wasmtime_context_t* store, const char* name, size_t name_len,
 ...
 */
WASM_API_EXTERN wasmtime_error_t* wasmtime_linker_instantiate(const wasmtime_linker_t* linker,
                                                              wasmtime_context_t* store,
 ...
 */
WASM_API_EXTERN wasmtime_error_t* wasmtime_linker_module(wasmtime_linker_t* linker,
                                                         wasmtime_context_t* store,
                                                         const char* name, size_t name_len,
                                                         const wasmtime_module_t* module);
 ...
 */
WASM_API_EXTERN wasmtime_error_t* wasmtime_linker_get_default(const wasmtime_linker_t* linker,
                                                              wasmtime_context_t* store,
                                                              const char* name, size_t name_len,
 ...
 */
WASM_API_EXTERN bool wasmtime_linker_get(const wasmtime_linker_t* linker, wasmtime_context_t* store,
...
WASM_API_EXTERN wasmtime_error_t* wasmtime_linker_instantiate_pre(
    const wasmtime_linker_t* linker, const wasmtime_module_t* module,
