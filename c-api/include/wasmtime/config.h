 ...
 */
WASM_API_EXTERN void wasmtime_config_cranelift_flag_set(wasm_config_t*, const char* key,
                                                        const char* value);
 ...
 */
typedef wasmtime_error_t* (*wasmtime_new_memory_callback_t)(void* env, const wasm_memorytype_t* ty,
 ...
 */
WASM_API_EXTERN void wasmtime_config_host_memory_creator_set(wasm_config_t*,
                                                             wasmtime_memory_creator_t*);
