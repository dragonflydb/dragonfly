...
run_fuzzer() {
    ...
    # Keep the target's stderr in the fuzzer output so an assertion / CHECK failure and its
    # stack trace reach the CI log. --minloglevel=2 (ERROR and above) keeps the volume down.
