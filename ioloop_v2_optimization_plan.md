...
| Metric | Source | Value |
|--------|--------|-------|
| V2 dispatch floor (noop, per-cmd individual hops) | R2 noop experiment | 2.41 µs |
| V1 squash dispatch floor (noop, per-batch-hop) | R4 noop experiment | 2.73 µs |
| V1 squash execution overhead (real − noop) | R1 − R2 | 0.73 µs |
| V2 individual-hop execution overhead (real − noop) | R3 − R4 | 1.10 µs |
