...
def jsonset(r, i):
    key = "json-{}".format(i)
    r.execute_command(
        "JSON.SET", key, ".", '{"a":123456, "b": "hello", "nested": {"abc": "ffffff", "bfb": null}}'
    )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="ReJSON Benchmark", formatter_class=argparse.ArgumentDefaultsHelpFormatter
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "-u", "--uri", type=str, default="redis://localhost:6379", help="Redis server URI"
    )
